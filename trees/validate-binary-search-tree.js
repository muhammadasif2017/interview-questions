...
class BinarySearchTree {
  ...
  validateBinarySearchTree() {
    ...
    while (queue.length > 0) {
      ...
      // console.log("Left value", currentNode.left.value || null);
      // console.log("Right value", currentNode.right.value || null);
      if (currentNode.left) {
...
console.log(myBinarySearchTree.validateBinarySearchTree());
